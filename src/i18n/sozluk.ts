...
interface Sozluk {
  ...
  // Sağlık turizmi (turlar altında ortak sayfa — fiyat/iptal alanı yok,
  // klinik ismi/logo/konum yok — jenerik hizmet tanıtımı, Ramses ile aynı desen)
  saglik_baslik: string;
  saglik_ozet: string;
  saglik_h1_alt: string;
  saglik_badge_danisma: string;
  saglik_badge_transfer: string;
  saglik_intro_baslik: string;
  saglik_intro_metin: string;
  saglik_hizmetler_baslik: string;
  saglik_kat_sac_baslik: string;
  saglik_kat_sac_metin: string;
  saglik_kat_dis_baslik: string;
  saglik_kat_dis_metin: string;
  saglik_kat_goz_baslik: string;
  ...
  saglik_adim1_baslik: string;
  saglik_adim1_metin: string;
  saglik_adim2_baslik: string;
  saglik_adim2_metin: string;
  saglik_adim3_baslik: string;
  saglik_adim3_metin: string;
  saglik_adim4_baslik: string;
  saglik_adim4_metin: string;
  saglik_guven_baslik: string;
  saglik_guven1_baslik: string;
  saglik_guven1_metin: string;
  saglik_guven2_baslik: string;
  saglik_guven2_metin: string;
  saglik_guven3_baslik: string;
  saglik_guven3_metin: string;
  saglik_guven4_baslik: string;
  saglik_guven4_metin: string;
  saglik_cta_baslik: string;
  saglik_cta_metin: string;
  saglik_wa_konu: string;
  saglik_wa_konu_sac: string;
  saglik_wa_konu_dis: string;
  saglik_wa_konu_goz: string;
  saglik_wa_konu_estetik: string;
  saglik_ana_teaser_baslik: string;
  saglik_ana_teaser_metin: string;
  saglik_ana_teaser_buton: string;
...
export const sozluk: Record<Dil, Sozluk> = {
  tr: {
    ...
    saglik_badge_transfer: 'Havalimanı Transferi Dahil',
    saglik_intro_baslik: 'Neden Türkiye’de tedavi',
    saglik_intro_metin: 'Türkiye, saç ekimi ve diş tedavisinde uzun süredir Avrupa’dan çok sayıda hasta ağırlıyor: aynı kalitede tedavi, İngiltere ve Batı Avrupa’ya kıyasla belirgin şekilde düşük maliyet. Antalya’daki anlaştığımız klinik konaklama ve transferi tedavi paketine dahil ediyor; siz yalnızca uçak biletinizi ayarlıyorsunuz.',
    saglik_hizmetler_baslik: 'Hizmetlerimiz',
    saglik_kat_sac_baslik: 'Saç Ekimi',
    saglik_kat_sac_metin: 'FUE ve DHI teknikleriyle saç, sakal ve kaş ekimi. Uygunluk değerlendirmesi fotoğraf üzerinden, uzaktan yapılır.',
    saglik_kat_dis_baslik: 'Diş Tedavisi',
    saglik_kat_dis_metin: 'İmplant, zirkonyum ve porselen kaplama, gülüş tasarımı. Tedavi planı ve fiyat teklifi fotoğraf veya röntgen üzerinden hazırlanır.',
    saglik_kat_goz_baslik: 'Göz Tedavileri',
    ...
    saglik_adim1_baslik: 'WhatsApp’tan yazın',
    saglik_adim1_metin: 'İstediğiniz tedaviyi ve varsa fotoğraflarınızı iletin.',
    saglik_adim2_baslik: 'Ön değerlendirme ve teklif',
    saglik_adim2_metin: 'Klinik ekibi fotoğraf ve bilgilerinizi inceler, tedavi planı ve fiyat teklifi WhatsApp’tan iletilir.',
    saglik_adim3_baslik: 'Seyahat planı',
    saglik_adim3_metin: 'Tarih netleşince uçuş ve konaklama planını birlikte ayarlarız, havalimanından karşılama dahildir.',
    saglik_adim4_baslik: 'Tedavi ve kontrol',
    saglik_adim4_metin: 'Tedavi klinikte yapılır, sonrasında kontrol ve iyileşme süreci takip edilir.',
    saglik_guven_baslik: 'Bilmeniz gerekenler',
    saglik_guven1_baslik: 'Lisanslı hekimler',
    saglik_guven1_metin: 'Türkiye’de sağlık hizmeti vermek Sağlık Bakanlığı lisansına tabidir.',
    saglik_guven2_baslik: 'Kendi dilinizde iletişim',
    saglik_guven2_metin: 'Türkçe, İngilizce, Rusça, Almanca, Lehçe ve Rumence koordinasyon desteği.',
    saglik_guven3_baslik: 'Konaklama ve transfer',
    saglik_guven3_metin: 'Otel ve havalimanı transferi tedavi paketine dahildir.',
    saglik_guven4_baslik: 'Tek muhatap',
    saglik_guven4_metin: 'Randevudan dönüşe kadar tüm süreci tek WhatsApp hattından takip edersiniz.',
    saglik_cta_baslik: 'Tedavi planı ve ön değerlendirme için WhatsApp’tan yazın',
    saglik_cta_metin: 'Fotoğraf gönderirseniz değerlendirme daha hızlı olur.',
    saglik_wa_konu: 'Sağlık turizmi hakkında bilgi almak istiyorum.',
    saglik_wa_konu_sac: 'Saç ekimi hakkında bilgi almak istiyorum.',
  ...
  en: {
    ...
    saglik_baslik: 'Health Tourism',
    saglik_ozet: 'We connect you with our partner clinic in Turkey for hair transplant, dental treatment, eye surgery and aesthetic procedures. Free initial assessment, booking on WhatsApp.',
    saglik_h1_alt: 'We connect you with our partner clinic for hair transplant, dental treatment, eye surgery and aesthetic procedures. Free initial assessment, book on WhatsApp.',
    saglik_badge_danisma: 'Free Initial Assessment',
    saglik_badge_transfer: 'Airport Transfer Included',
    saglik_intro_baslik: 'Why treatment in Turkey',
    saglik_intro_metin: 'Turkey has hosted large numbers of patients from Europe for hair transplant and dental treatment for years: the same quality of care, at a noticeably lower cost than the UK or Western Europe. Our partner clinic in Antalya includes accommodation and transfer in the treatment package — you only arrange your flight.',
    saglik_hizmetler_baslik: 'Our Services',
    saglik_kat_sac_baslik: 'Hair Transplant',
    saglik_kat_sac_metin: 'Hair, beard and eyebrow transplant using FUE and DHI techniques. Suitability is assessed remotely from photos.',
    saglik_kat_dis_baslik: 'Dental Treatment',
    saglik_kat_dis_metin: 'Implants, zirconium and porcelain veneers, smile design. The treatment plan and quote are prepared from photos or X-rays.',
    saglik_kat_goz_baslik: 'Eye Treatments',
    ...
    saglik_adim1_baslik: 'Message us on WhatsApp',
    saglik_adim1_metin: 'Tell us which treatment you’re interested in and share photos if you have them.',
    saglik_adim2_baslik: 'Assessment and quote',
    saglik_adim2_metin: 'The clinic reviews your photos and information, then sends a treatment plan and quote on WhatsApp.',
    saglik_adim3_baslik: 'Travel plan',
    saglik_adim3_metin: 'Once a date is set, we arrange flights and accommodation together; airport pickup is included.',
    saglik_adim4_baslik: 'Treatment and follow-up',
    saglik_adim4_metin: 'Treatment takes place at the clinic, followed by check-ups during your recovery.',
    saglik_guven_baslik: 'What you should know',
    saglik_guven1_baslik: 'Licensed doctors',
    saglik_guven1_metin: 'Providing healthcare in Turkey requires a Ministry of Health license.',
    saglik_guven2_baslik: 'Support in your language',
    saglik_guven2_metin: 'Coordination in Turkish, English, Russian, German, Polish and Romanian.',
    saglik_guven3_baslik: 'Accommodation and transfer',
    saglik_guven3_metin: 'Hotel stay and airport transfer are included in the treatment package.',
    saglik_guven4_baslik: 'One point of contact',
    saglik_guven4_metin: 'You follow the whole process, from booking to your return flight, on a single WhatsApp line.',
    saglik_cta_baslik: 'Message us on WhatsApp for a treatment plan and assessment',
    saglik_cta_metin: 'Sending photos speeds up the assessment.',
    saglik_wa_konu: 'I would like information about health tourism.',
    saglik_wa_konu_sac: 'I would like information about hair transplant.',
    saglik_wa_konu_dis: 'I would like information about dental treatment.',
    saglik_wa_konu_goz: 'I would like information about eye treatment.',
    saglik_wa_konu_estetik: 'I would like information about aesthetic procedures.',
    saglik_ana_teaser_baslik: 'Health Tourism',
    saglik_ana_teaser_metin: 'We connect you with our partner clinic for hair transplant, dental treatment, eye surgery and aesthetic procedures. Free initial assessment.',
    saglik_ana_teaser_buton: 'See the Services',
  ...
  ru: {
    ...
    saglik_baslik: 'Медицинский туризм',
    saglik_ozet: 'Мы связываем вас с партнёрской клиникой в Турции для трансплантации волос, стоматологии, операций на глазах и эстетических процедур. Бесплатная первичная оценка, запись через WhatsApp.',
    saglik_h1_alt: 'Мы связываем вас с партнёрской клиникой для трансплантации волос, стоматологии, операций на глазах и эстетических процедур. Бесплатная первичная оценка, запись через WhatsApp.',
    saglik_badge_danisma: 'Бесплатная первичная оценка',
    saglik_badge_transfer: 'Трансфер из аэропорта включён',
    saglik_intro_baslik: 'Почему лечение в Турции',
    saglik_intro_metin: 'Турция много лет принимает пациентов из Европы на трансплантацию волос и лечение зубов: то же качество, заметно ниже стоимость, чем в Великобритании и Западной Европе. Наша партнёрская клиника в Анталье включает проживание и трансфер в пакет лечения — вам нужно организовать только перелёт.',
    saglik_hizmetler_baslik: 'Наши услуги',
    saglik_kat_sac_baslik: 'Трансплантация волос',
    saglik_kat_sac_metin: 'Пересадка волос, бороды и бровей методами FUE и DHI. Оценка проводится удалённо по фотографиям.',
    saglik_kat_dis_baslik: 'Стоматология',
    saglik_kat_dis_metin: 'Импланты, циркониевые и керамические виниры, дизайн улыбки. План лечения и стоимость готовятся по фото или рентгену.',
    saglik_kat_goz_baslik: 'Лечение глаз',
    ...
    saglik_adim1_baslik: 'Напишите в WhatsApp',
    saglik_adim1_metin: 'Расскажите, какое лечение вас интересует, и приложите фото, если они есть.',
    saglik_adim2_baslik: 'Оценка и стоимость',
    saglik_adim2_metin: 'Клиника изучает ваши фото и данные и присылает план лечения со стоимостью в WhatsApp.',
    saglik_adim3_baslik: 'План поездки',
    saglik_adim3_metin: 'После согласования даты вместе организуем перелёт и проживание; трансфер из аэропорта включён.',
    saglik_adim4_baslik: 'Лечение и наблюдение',
    saglik_adim4_metin: 'Лечение проходит в клинике, после — контроль и сопровождение восстановления.',
    saglik_guven_baslik: 'Что важно знать',
    saglik_guven1_baslik: 'Лицензированные врачи',
    saglik_guven1_metin: 'Медицинская деятельность в Турции требует лицензии Министерства здравоохранения.',
    saglik_guven2_baslik: 'Поддержка на вашем языке',
    saglik_guven2_metin: 'Координация на турецком, английском, русском, немецком, польском и румынском.',
    saglik_guven3_baslik: 'Проживание и трансфер',
    saglik_guven3_metin: 'Проживание в отеле и трансфер из аэропорта включены в пакет лечения.',
    saglik_guven4_baslik: 'Один контакт на весь процесс',
    saglik_guven4_metin: 'Весь процесс, от записи до вылета домой, вы ведёте через один номер WhatsApp.',
    saglik_cta_baslik: 'Напишите в WhatsApp для плана лечения и оценки',
    saglik_cta_metin: 'Если пришлёте фото, оценка будет быстрее.',
    saglik_wa_konu: 'Хотел(а) бы узнать подробнее о медицинском туризме.',
    saglik_wa_konu_sac: 'Хотел(а) бы узнать подробнее о трансплантации волос.',
    saglik_wa_konu_dis: 'Хотел(а) бы узнать подробнее о стоматологическом лечении.',
    saglik_wa_konu_goz: 'Хотел(а) бы узнать подробнее о лечении глаз.',
    saglik_wa_konu_estetik: 'Хотел(а) бы узнать подробнее об эстетических процедурах.',
    saglik_ana_teaser_baslik: 'Медицинский туризм',
    saglik_ana_teaser_metin: 'Мы связываем вас с партнёрской клиникой для трансплантации волос, стоматологии, операций на глазах и эстетических процедур. Бесплатная первичная оценка.',
    saglik_ana_teaser_buton: 'Смотреть услуги',
  ...
  de: {
    ...
    saglik_baslik: 'Gesundheitstourismus',
    saglik_ozet: 'Wir vermitteln Sie an unsere Partnerklinik in der Türkei für Haartransplantation, Zahnbehandlung, Augenoperationen und ästhetische Eingriffe. Kostenlose Erstbewertung, Terminvereinbarung über WhatsApp.',
    saglik_h1_alt: 'Wir vermitteln Sie an unsere Partnerklinik für Haartransplantation, Zahnbehandlung, Augenoperationen und ästhetische Eingriffe. Kostenlose Erstbewertung, Termin über WhatsApp.',
    saglik_badge_danisma: 'Kostenlose Erstbewertung',
    saglik_badge_transfer: 'Flughafentransfer inklusive',
    saglik_intro_baslik: 'Warum Behandlung in der Türkei',
    saglik_intro_metin: 'Die Türkei behandelt seit Jahren viele Patienten aus Europa bei Haartransplantation und Zahnbehandlung: gleiche Qualität, deutlich niedrigere Kosten als in Großbritannien oder Westeuropa. Unsere Partnerklinik in Antalya inkludiert Unterkunft und Transfer im Behandlungspaket — Sie organisieren nur den Flug.',
    saglik_hizmetler_baslik: 'Unsere Leistungen',
    saglik_kat_sac_baslik: 'Haartransplantation',
    saglik_kat_sac_metin: 'Haar-, Bart- und Augenbrauentransplantation mit FUE- und DHI-Technik. Die Eignung wird anhand von Fotos aus der Ferne beurteilt.',
    saglik_kat_dis_baslik: 'Zahnbehandlung',
    saglik_kat_dis_metin: 'Implantate, Zirkon- und Keramikveneers, Smile Design. Behandlungsplan und Kostenvoranschlag werden anhand von Fotos oder Röntgenbildern erstellt.',
    saglik_kat_goz_baslik: 'Augenbehandlungen',
    ...
    saglik_adim1_baslik: 'Schreiben Sie uns auf WhatsApp',
    saglik_adim1_metin: 'Teilen Sie uns die gewünschte Behandlung mit und senden Sie, falls vorhanden, Fotos.',
    saglik_adim2_baslik: 'Bewertung und Angebot',
    saglik_adim2_metin: 'Die Klinik prüft Ihre Fotos und Angaben und sendet Behandlungsplan und Kostenvoranschlag per WhatsApp.',
    saglik_adim3_baslik: 'Reiseplanung',
    saglik_adim3_metin: 'Nach Terminfindung planen wir gemeinsam Flug und Unterkunft; die Abholung vom Flughafen ist inklusive.',
    saglik_adim4_baslik: 'Behandlung und Nachsorge',
    saglik_adim4_metin: 'Die Behandlung findet in der Klinik statt, danach folgen Kontrollen während der Genesung.',
    saglik_guven_baslik: 'Was Sie wissen sollten',
    saglik_guven1_baslik: 'Lizenzierte Ärzte',
    saglik_guven1_metin: 'Medizinische Leistungen in der Türkei erfordern eine Lizenz des Gesundheitsministeriums.',
    saglik_guven2_baslik: 'Unterstützung in Ihrer Sprache',
    saglik_guven2_metin: 'Koordination auf Türkisch, Englisch, Russisch, Deutsch, Polnisch und Rumänisch.',
    saglik_guven3_baslik: 'Unterkunft und Transfer',
    saglik_guven3_metin: 'Hotelaufenthalt und Flughafentransfer sind im Behandlungspaket enthalten.',
    saglik_guven4_baslik: 'Ein Ansprechpartner',
    saglik_guven4_metin: 'Von der Terminvereinbarung bis zum Rückflug begleiten wir Sie über eine einzige WhatsApp-Nummer.',
    saglik_cta_baslik: 'Schreiben Sie uns auf WhatsApp für Behandlungsplan und Bewertung',
    saglik_cta_metin: 'Mit Fotos geht die Bewertung schneller.',
    saglik_wa_konu: 'Ich hätte gerne Informationen zum Gesundheitstourismus.',
    saglik_wa_konu_sac: 'Ich hätte gerne Informationen zur Haartransplantation.',
    saglik_wa_konu_dis: 'Ich hätte gerne Informationen zur Zahnbehandlung.',
    saglik_wa_konu_goz: 'Ich hätte gerne Informationen zur Augenbehandlung.',
    saglik_wa_konu_estetik: 'Ich hätte gerne Informationen zu ästhetischen Eingriffen.',
    saglik_ana_teaser_baslik: 'Gesundheitstourismus',
    saglik_ana_teaser_metin: 'Wir vermitteln Sie an unsere Partnerklinik für Haartransplantation, Zahnbehandlung, Augenoperationen und ästhetische Eingriffe. Kostenlose Erstbewertung.',
    saglik_ana_teaser_buton: 'Leistungen ansehen',
  ...
  pl: {
    ...
    saglik_baslik: 'Turystyka medyczna',
    saglik_ozet: 'Łączymy Was z naszą kliniką partnerską w Turcji w zakresie przeszczepu włosów, leczenia stomatologicznego, zabiegów okulistycznych i estetycznych. Bezpłatna wstępna ocena, umawianie przez WhatsApp.',
    saglik_h1_alt: 'Łączymy Was z naszą kliniką partnerską w zakresie przeszczepu włosów, leczenia stomatologicznego, zabiegów okulistycznych i estetycznych. Bezpłatna wstępna ocena, kontakt przez WhatsApp.',
    saglik_badge_danisma: 'Bezpłatna wstępna ocena',
    saglik_badge_transfer: 'Transfer z lotniska w cenie',
    saglik_intro_baslik: 'Dlaczego leczenie w Turcji',
    saglik_intro_metin: 'Turcja od lat przyjmuje wielu pacjentów z Europy na przeszczep włosów i leczenie stomatologiczne: ta sama jakość, wyraźnie niższy koszt niż w Wielkiej Brytanii czy Europie Zachodniej. Nasza klinika partnerska w Antalyi w cenę leczenia wlicza zakwaterowanie i transfer — Wy organizujecie tylko lot.',
    saglik_hizmetler_baslik: 'Nasze usługi',
    saglik_kat_sac_baslik: 'Przeszczep włosów',
    saglik_kat_sac_metin: 'Przeszczep włosów, brody i brwi metodą FUE i DHI. Ocena kwalifikacji odbywa się zdalnie na podstawie zdjęć.',
    saglik_kat_dis_baslik: 'Leczenie stomatologiczne',
    saglik_kat_dis_metin: 'Implanty, licówki cyrkonowe i porcelanowe, projektowanie uśmiechu. Plan leczenia i wycena przygotowywane są na podstawie zdjęć lub zdjęć rentgenowskich.',
    saglik_kat_goz_baslik: 'Zabiegi okulistyczne',
    ...
    saglik_adim1_baslik: 'Napisz na WhatsApp',
    saglik_adim1_metin: 'Napisz, jakim zabiegiem jesteś zainteresowany/a, i dołącz zdjęcia, jeśli je masz.',
    saglik_adim2_baslik: 'Ocena i wycena',
    saglik_adim2_metin: 'Klinika analizuje zdjęcia i informacje, a następnie przesyła plan leczenia oraz wycenę przez WhatsApp.',
    saglik_adim3_baslik: 'Plan podróży',
    saglik_adim3_metin: 'Po ustaleniu terminu wspólnie planujemy lot i zakwaterowanie; odbiór z lotniska jest wliczony.',
    saglik_adim4_baslik: 'Leczenie i opieka po zabiegu',
    saglik_adim4_metin: 'Zabieg odbywa się w klinice, później następują kontrole w trakcie rekonwalescencji.',
    saglik_guven_baslik: 'Co warto wiedzieć',
    saglik_guven1_baslik: 'Licencjonowani lekarze',
    saglik_guven1_metin: 'Świadczenie usług medycznych w Turcji wymaga licencji Ministerstwa Zdrowia.',
    saglik_guven2_baslik: 'Wsparcie w Twoim języku',
    saglik_guven2_metin: 'Koordynacja w językach: tureckim, angielskim, rosyjskim, niemieckim, polskim i rumuńskim.',
    saglik_guven3_baslik: 'Zakwaterowanie i transfer',
    saglik_guven3_metin: 'Pobyt w hotelu i transfer z lotniska są wliczone w pakiet leczenia.',
    saglik_guven4_baslik: 'Jeden punkt kontaktu',
    saglik_guven4_metin: 'Cały proces, od umówienia po lot powrotny, prowadzicie przez jeden numer WhatsApp.',
    saglik_cta_baslik: 'Napisz na WhatsApp po plan leczenia i wycenę',
    saglik_cta_metin: 'Przesłanie zdjęć przyspiesza ocenę.',
    saglik_wa_konu: 'Chciałbym/Chciałabym dowiedzieć się więcej o turystyce medycznej.',
    saglik_wa_konu_sac: 'Chciałbym/Chciałabym dowiedzieć się więcej o przeszczepie włosów.',
    saglik_wa_konu_dis: 'Chciałbym/Chciałabym dowiedzieć się więcej o leczeniu stomatologicznym.',
    saglik_wa_konu_goz: 'Chciałbym/Chciałabym dowiedzieć się więcej o zabiegach okulistycznych.',
    saglik_wa_konu_estetik: 'Chciałbym/Chciałabym dowiedzieć się więcej o zabiegach estetycznych.',
    saglik_ana_teaser_baslik: 'Turystyka medyczna',
    saglik_ana_teaser_metin: 'Łączymy Was z naszą kliniką partnerską w zakresie przeszczepu włosów, leczenia stomatologicznego, zabiegów okulistycznych i estetycznych. Bezpłatna wstępna ocena.',
    saglik_ana_teaser_buton: 'Zobacz usługi',
  ...
  ro: {
    ...
    saglik_baslik: 'Turism medical',
    saglik_ozet: 'Vă punem în legătură cu clinica noastră parteneră din Turcia pentru transplant de păr, tratamente stomatologice, intervenții oftalmologice și proceduri estetice. Evaluare inițială gratuită, programare pe WhatsApp.',
    saglik_h1_alt: 'Vă punem în legătură cu clinica noastră parteneră pentru transplant de păr, tratamente stomatologice, intervenții oftalmologice și proceduri estetice. Evaluare inițială gratuită, programare pe WhatsApp.',
    saglik_badge_danisma: 'Evaluare inițială gratuită',
    saglik_badge_transfer: 'Transfer de la aeroport inclus',
    saglik_intro_baslik: 'De ce tratament în Turcia',
    saglik_intro_metin: 'Turcia primește de mulți ani numeroși pacienți din Europa pentru transplant de păr și tratamente stomatologice: aceeași calitate, cost vizibil mai mic decât în Marea Britanie sau Europa de Vest. Clinica noastră parteneră din Antalya include cazarea și transferul în pachetul de tratament — dumneavoastră organizați doar zborul.',
    saglik_hizmetler_baslik: 'Serviciile noastre',
    saglik_kat_sac_baslik: 'Transplant de păr',
    saglik_kat_sac_metin: 'Transplant de păr, barbă și sprâncene prin tehnicile FUE și DHI. Evaluarea eligibilității se face de la distanță, pe bază de fotografii.',
    saglik_kat_dis_baslik: 'Tratamente stomatologice',
    saglik_kat_dis_metin: 'Implanturi, fațete din zirconiu și porțelan, design al zâmbetului. Planul de tratament și oferta se pregătesc pe baza fotografiilor sau radiografiilor.',
    saglik_kat_goz_baslik: 'Tratamente oftalmologice',
    ...
    saglik_adim1_baslik: 'Scrieți-ne pe WhatsApp',
    saglik_adim1_metin: 'Spuneți-ne ce tratament vă interesează și trimiteți fotografii, dacă aveți.',
    saglik_adim2_baslik: 'Evaluare și ofertă',
    saglik_adim2_metin: 'Clinica analizează fotografiile și informațiile, apoi trimite planul de tratament și oferta pe WhatsApp.',
    saglik_adim3_baslik: 'Plan de călătorie',
    saglik_adim3_metin: 'După stabilirea datei, organizăm împreună zborul și cazarea; preluarea de la aeroport este inclusă.',
    saglik_adim4_baslik: 'Tratament și urmărire',
    saglik_adim4_metin: 'Tratamentul are loc la clinică, urmat de controale pe parcursul recuperării.',
    saglik_guven_baslik: 'Ce trebuie să știți',
    saglik_guven1_baslik: 'Medici licențiați',
    saglik_guven1_metin: 'Furnizarea de servicii medicale în Turcia necesită licență din partea Ministerului Sănătății.',
    saglik_guven2_baslik: 'Sprijin în limba dumneavoastră',
    saglik_guven2_metin: 'Coordonare în turcă, engleză, rusă, germană, poloneză și română.',
    saglik_guven3_baslik: 'Cazare și transfer',
    saglik_guven3_metin: 'Cazarea la hotel și transferul de la aeroport sunt incluse în pachetul de tratament.',
    saglik_guven4_baslik: 'Un singur punct de contact',
    saglik_guven4_metin: 'Urmăriți întregul proces, de la programare până la zborul de întoarcere, pe un singur număr de WhatsApp.',
    saglik_cta_baslik: 'Scrieți-ne pe WhatsApp pentru plan de tratament și evaluare',
    saglik_cta_metin: 'Trimiterea fotografiilor grăbește evaluarea.',
    saglik_wa_konu: 'Aș dori informații despre turismul medical.',
    saglik_wa_konu_sac: 'Aș dori informații despre transplantul de păr.',
    saglik_wa_konu_dis: 'Aș dori informații despre tratamentele stomatologice.',
    saglik_wa_konu_goz: 'Aș dori informații despre tratamentele oftalmologice.',
    saglik_wa_konu_estetik: 'Aș dori informații despre procedurile estetice.',
    saglik_ana_teaser_baslik: 'Turism medical',
    saglik_ana_teaser_metin: 'Vă punem în legătură cu clinica noastră parteneră pentru transplant de păr, tratamente stomatologice, intervenții oftalmologice și proceduri estetice. Evaluare inițială gratuită.',
    saglik_ana_teaser_buton: 'Vezi serviciile',
